...
function renderSnapshotModal(cats, latestVals, dateVals, editDate) {
  ...
  openModal(`
    ...
    <div class="date-selector">
      ...
      <input type="date" id="snap-date-native" value="${snapDate}" max="${todayStr()}" onchange="onSnapDateChange(this.value)" style="font-size:16px;font-weight:600;color:var(--primary);border:none;background:transparent;outline:none;padding:0;flex:1;min-width:0;line-height:1.4;-webkit-appearance:textfield">
    </div>

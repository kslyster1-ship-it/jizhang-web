...
function renderSnapshotModal(cats, latestVals, dateVals, editDate) {
  ...
  openModal(`
    ...
    <label class="date-selector" for="snap-date-native" style="position:relative">
      ...
      <input type="date" id="snap-date-native" value="${snapDate}" max="${todayStr()}" onchange="onSnapDateChange(this.value)" style="font-size:16px;font-weight:600;color:var(--primary);border:none;background:transparent;outline:none;padding:0;flex:1;min-width:0">
